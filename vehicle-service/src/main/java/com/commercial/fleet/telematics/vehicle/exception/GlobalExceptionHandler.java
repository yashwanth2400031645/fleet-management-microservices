...
import com.commercial.fleet.telematics.vehicle.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
	...
	/** Thrown by @PreAuthorize; must be mapped explicitly or the catch-all below turns it into a 500. */
	...
	public ResponseEntity<ErrorResponse> handleUnreadable(HttpMessageNotReadableException ex, HttpServletRequest req) {
		// Covers malformed JSON and unknown enum values (e.g. type = "BUS").
