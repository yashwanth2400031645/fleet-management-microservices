...
import com.commercial.fleet.telematics.vehicle.security.GatewayIdentityFilter;
...
/**
 * Every /api/** call must carry a gateway identity; role checks live on the
 * service methods via @PreAuthorize. Actuator health stays open for probes.
 */
@Configuration
@EnableWebSecurity
