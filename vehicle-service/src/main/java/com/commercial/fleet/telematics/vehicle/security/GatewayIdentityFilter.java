 ...
 * (X-User-Id / X-Username / X-User-Role). The gateway overwrites any
 * client-supplied copies, so this service must only be reachable through it.
 * Requests without the headers stay anonymous and are rejected by SecurityConfig.
 */
@Component
@Slf4j
