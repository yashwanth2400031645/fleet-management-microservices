...
import com.commercial.fleet.telematics.maintenance.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler({VehicleConflictException.class, InvalidMaintenanceTransitionException.class})
